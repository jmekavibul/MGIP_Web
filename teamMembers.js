...
export const teamMembers = [
    ...
    },
    {
      ...
      },
      {
        ...
        title: 'OF COUNSEL',
        email: 'rwg@mg-ip.com',
        phone: '(703)621-7140 x 120',
        photo: rui, // Replace with the path to the photo
        education: ['Georgetown University Law Center (L.L.M.)', 'Seikei University, Tokyo (Masters of Law)'],
        memberships: [],
        activities: ['Member of INTA Committee (INTA Bulletin Committee for 2016-2017 and 2020-2021,  and Internet Committee for 2018-2019)', 'Teaching US Legal Writing, Research and Analysis as Adjunct Professor at Georgetown University Law Center since 2022'],
        experience: ['Ms. Geissler specializes in trademark prosecution and the protection of intellectual property in Asia and the United States. Her practice encompasses trademark searching and monitoring, assignment and licensing, and renewal and amendment. She advises and counsels international clients on the enforcement of intellectual property rights and in connection with compliance and dispute resolution matters. She has worked in large, respected law firms in Beijing, Tokyo and Washington, DC advising clients on matters involving licensing, distribution, agency, franchising and branding, and in connection with cross-border transactional and investment matters relating to intangible assets and IP rights.'],
        bar:['New York State']
      },
      {
        id: "Hyung",
      ...
      },
      {
        ...
        memberships: ['GRUR – German Intellectual Property Association', 'ECTA – European Community Trademark Association', 'INTA – The Trademark Reporter Committee', 'MARQUES – European Brand Owners Association – Unfair Competition Team'],
      ...
      },
      {
        ...
        title: 'OF COUNSEL',
        email: 'jes@mg-ip.com',
        phone: '(703)621-7140 x 172',
        photo: jeffreyS, // Replace with the path to the photo
        education: ['University of Denver, Sturm College of Law (J.D.)', 'Denver University Law Review, Senior Staff Editor and Articles Author', 'Moot Court Board, Competition Chair', 'University of Cincinnati (M.B.A., Finance and International Business, cum laude)', 'Beta Gamma Sigma Business Honorary', 'University of Cincinnati (B.S., Electrical Engineering)', 
        'Cincinnatus Honorary Society', 'Texnikoi Engineering Honorary'],
        memberships: ['American Bar Association, Section of Intellectual Property Law (ABA-IPL)', 'Institute of Electrical and Electronics Engineers (IEEE), Communications Society and Computer Society'],
        bar:['Colorado', 'Registered to practice before the U.S. Patent and Trademark Office'],
        experience:['Mr. Santry has over fifteen years of experience in intellectual property law, concentrating his practice on domestic and international patent preparation and prosecution. He also provides strategic counsel and opinions to clients on issues involving patent infringement and validity, freedom-to-operate, patent asset due diligence, licensing intellectual property rights and technology-focused contractual matters. Mr. Santry is experienced in preparing and prosecuting patent applications in a wide range of advanced technologies, including wireless and broadband communications (e.g., 5G-NR, LTE, OFDM, etc.), satellite systems, routing and signaling protocols (e.g., VoIP, SIP, RTP streams, etc.), video and data compression, packet encoding/decoding, data error correction and encryption, laser and optical devices, semiconductor fabrication and integrated circuit designs, medical devices, memory devices, cloud computing and software.','Prior to joining Muncy, Geissler, Olds & Lowe, PLLC, Mr. Santry practiced law for over twelve years at several international Am Law 100 and Am Law 200 law firms. Before practicing law, he held engineering and senior leadership positions with multinational cable and telecommunications companies, including Comcast Corp. and AT&T. Applying his business and industry experience to his law practice, Mr. Santry provides practical, strategic, and solution-driven legal counsel to clients for maximizing the value of their intellectual property/patent portfolio assets and advancing their business objectives.']
      },
      {
        id: "Simone",
        name: 'Simone Chen',
      ...
      },
      {
        ...
        memberships: ['International Trademark Association (INTA)','Asociación Interamericana de la Propiedad Intelectual (ASIPI)',
        'American Bar Association (ABA)', 'New York State Bar Association (NYSBA)'],
      ...
      },
      {
        ...
        experienceList:['Analog and digital circuits', 'Semiconductor manufacturing processes', 'Semiconductor manufacturing equipment', 'Telecommunications, including LTE, 5G, Error Correction Codes, and Advanced Television Systems Committee (ATSC) Standards', 'Video Coding/Decoding Technology, including H.264, High Efficiency Video Coding (HEVC), and Versatile Video Coding (VVC) standards']
      },
      {
        id: "Tetsu",
        name: 'Tetsu Yoshida',
